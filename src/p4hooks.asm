...
;
; NEW APPROACH: Intercept SETNAM to capture filename parameters
; directly from the emulated CPU registers, then use them when
; the LOAD KERNAL call happens.
;
; ============================================================
...
; DIRECTORY keyword handler entry (from BASIC keyword vector table)
...
; 32-bit pointer for direct memory access (in zero page)
...
; ============================================================
; DIRECTORY support (preserved from original)
; ============================================================
